...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section style={{ background: 'linear-gradient(180deg, #13131a 0%, #0d0d12 100%)', borderTop: '1px solid #2a2a3a', borderBottom: '1px solid #2a2a3a' }} className="px-6 py-12 md:py-16 text-center">
        ...
        <h2 style={{ background: 'linear-gradient(135deg, #f472b6, #a855f7)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', fontSize: 'clamp(24px, 4vw, 40px)', fontWeight: 900, lineHeight: 1.2, marginBottom: 16 }}>
        ...
        <div className="flex items-center justify-center gap-3 flex-wrap">
          <Link href="/cases/new" style={{ background: 'linear-gradient(135deg, #be123c, #ec4899)', color: 'white', fontWeight: 700, fontSize: 14, padding: '10px 24px', borderRadius: 999, textDecoration: 'none', display: 'inline-block' }}>
            + Reportar un caso
          </Link>
          <Link href="/recursos" style={{ background: 'transparent', color: '#c084fc', border: '1px solid #9333ea44', fontWeight: 600, fontSize: 14, padding: '10px 24px', borderRadius: 999, textDecoration: 'none', display: 'inline-block' }}>
            ¿Dónde denunciar?
          </Link>
        </div>
      </section>
